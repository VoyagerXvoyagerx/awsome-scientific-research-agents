...
|------|------|------|:------------:|-------|------|
| autoresearch | Andrej Karpathy的自主ML研究代理，让AI在单GPU上自动运行实验并改进模型 | agent | <!--stars:karpathy/autoresearch-->⭐ 92k<!--/stars--> | - | [GitHub](https://github.com/karpathy/autoresearch) |
...
| ARS | Claude Code学术研究技能套件，覆盖从文献调研到论文发表的全流程 | skill | <!--stars:Imbad0202/academic-research-skills-->⭐ 39.4k<!--/stars--> | - | [GitHub](https://github.com/Imbad0202/academic-research-skills) / 内置Claude Code技能 |
